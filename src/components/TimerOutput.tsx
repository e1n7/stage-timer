...
const IconLogo = ({ size = 20 }: { size?: number }) => (
...
export const TimerOutput = () => {
  ...
  return (
    ...
    >
      <div className="absolute left-6 top-6 z-50 flex items-center gap-3 opacity-20 group-hover:opacity-100 transition-opacity duration-300">
        <IconLogo size={32} />
        <span className="text-[20px] font-black tracking-tighter text-white uppercase">Stage Timer</span>
      </div>
